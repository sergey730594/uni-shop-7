...
export const Header: React.FC<HeaderProps> = ({
  ...
  const cakeCategories: Record<string, { name: string; slug: string }[]> = {
    ...
    en: [
      { name: 'Corporate Cakes', slug: 'corporate' }, { name: 'Wedding Cakes', slug: 'wedding' },
      { name: 'Kids Cakes', slug: 'kids' }, { name: 'Photo Cakes', slug: 'photo' },
      { name: 'Car Cakes', slug: 'car' }, { name: 'Sports Cakes', slug: 'sports' },
      { name: 'Heart Cakes', slug: 'heart' }, { name: 'Marzipan Cakes', slug: 'marzipan' },
      { name: 'Baptism Cakes', slug: 'baptism' }, { name: 'Round Cakes', slug: 'round' },
      { name: 'Cakes for Adults', slug: 'adults' }, { name: 'Square Cakes', slug: 'square' },
      { name: 'New Year Cakes', slug: 'new-year' },
    ],
    ru: [
      { name: 'Корпоративные торты', slug: 'corporate' }, { name: 'Свадебные торты', slug: 'wedding' },
      { name: 'Детские торты', slug: 'kids' }, { name: 'Фото торты', slug: 'photo' },
      { name: 'Торты-машины', slug: 'car' }, { name: 'Спортивные торты', slug: 'sports' },
      { name: 'Торты-сердца', slug: 'heart' }, { name: 'Марципановые торты', slug: 'marzipan' },
      { name: 'Торты на крестины', slug: 'baptism' }, { name: 'Круглые торты', slug: 'round' },
      { name: 'Торты для взрослых', slug: 'adults' }, { name: 'Квадратные торты', slug: 'square' },
      { name: 'Новогодние торты', slug: 'new-year' },
    ],
    tr: [
      { name: 'Kurumsal Pastalar', slug: 'corporate' }, { name: 'Düğün Pastaları', slug: 'wedding' },
      ...
      { name: 'Kalp Pastaları', slug: 'heart' }, { name: 'Badem Ezmesi Pastaları', slug: 'marzipan' },
      { name: 'Vaftiz Pastaları', slug: 'baptism' }, { name: 'Yuvarlak Pastalar', slug: 'round' },
      { name: 'Yetişkinler için Pastalar', slug: 'adults' }, { name: 'Kare Pastalar', slug: 'square' },
