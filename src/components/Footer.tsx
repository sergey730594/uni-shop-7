...
// Иконки SVG вместо lucide-react
const LocationIcon = () => (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="space-y-4">
            ...
            {/* Социальные сети */}
            <div>
              <p className="text-sm font-medium text-gray-700 mb-2">{t.followUs}</p>
          ...
          {/* Средняя колонка - Мессенджеры и реквизиты */}
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
                ...
                <div>
                  <p className="font-medium text-gray-800">Viber</p>
              ...
              <div className="flex items-center gap-3 p-3 bg-green-50 rounded-xl hover:bg-green-100 transition">
                <div className="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center text-white">
                  <WhatsAppIcon />
                </div>
                <div>
                  <p className="font-medium text-gray-800">WhatsApp</p>
                  <a href="#" className="text-sm text-gray-500 hover:text-green-600 transition">
                    {t.phone}
                  </a>
                </div>
              </div>
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <p className="text-sm text-gray-500">
                <span className="font-medium text-gray-700">ОГРН:</span> 1234567890123
              </p>
            </div>
          </div>
